<script lang="ts">
  ...
  import { CalendarPlusOutline, DownloadOutline, MailBoxOutline } from 'flowbite-svelte-icons';
</script>
...
<Section name="feature">
  ...
  >
    {#snippet h2()}Get down to brass tacks{/snippet}
  ...
  <FeatureDefault>
    ...
    <FeatureItem>
      {#snippet icon()}<CalendarPlusOutline
        ...
        />{/snippet}
      {#snippet h3()}No Strings Attached{/snippet}
      {#snippet paragraph()}
